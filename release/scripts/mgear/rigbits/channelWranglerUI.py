...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.export_pushButton.setText(pyqt.fakeTranslate("Form", "导出", None, -1))
        self.import_pushButton.setText(pyqt.fakeTranslate("Form", "导入", None, -1))
        self.apply_pushButton.setText(pyqt.fakeTranslate("Form", "应用", None, -1))
