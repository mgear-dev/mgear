...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.xgen_description_label.setText(pyqt.fakeTranslate("Form", "描述", None, -1))
        self.xgen_description_pushButton.setText(pyqt.fakeTranslate("Form", "<<", None, -1))
        self.add_curve_pushButton.setText(pyqt.fakeTranslate("Form", "添加曲线引导", None, -1))
        self.groupBox_2.setTitle(pyqt.fakeTranslate("Form", "修改", None, -1))
        self.duplicate_pushButton.setToolTip(pyqt.fakeTranslate("Form", "复制点击会话", None, -1))
        self.duplicate_pushButton.setText(pyqt.fakeTranslate("Form", "复制", None, -1))
        self.duplicate_sym_pushButton.setToolTip(pyqt.fakeTranslate("Form", "对称复制选中项", None, -1))
        self.duplicate_sym_pushButton.setText(pyqt.fakeTranslate("Form", "对称复制", None, -1))
        self.move_pushButton.setToolTip(pyqt.fakeTranslate("Form", "移动引导点击会话", None, -1))
        self.move_pushButton.setText(pyqt.fakeTranslate("Form", "移动", None, -1))
        self.color_groupBox.setTitle(pyqt.fakeTranslate("Form", "颜色", None, -1))
        self.groupBox_4.setTitle(pyqt.fakeTranslate("Form", "选项", None, -1))
        self.lock_length_checkBox.setToolTip(pyqt.fakeTranslate("Form", "锁定引导线长度", None, -1))
        self.lenght_label.setText(pyqt.fakeTranslate("Form", "长度", None, -1))
        self.sections_label.setText(pyqt.fakeTranslate("Form", "点数", None, -1))
        self.thickness_label.setText(pyqt.fakeTranslate("Form", "粗细", None, -1))
        self.label_5.setText(pyqt.fakeTranslate("Form", "插值", None, -1))
        self.interpolated_shape_checkBox.setToolTip(pyqt.fakeTranslate("Form", "插值曲线引导形状", None, -1))
        self.interpolated_shape_checkBox.setText(pyqt.fakeTranslate("Form", "形状", None, -1))
        self.interpolated_scale_checkBox.setToolTip(pyqt.fakeTranslate("Form", "插值曲线引导缩放", None, -1))
        self.interpolated_scale_checkBox.setText(pyqt.fakeTranslate("Form", "缩放", None, -1))
        self.interpolated_rotate_checkBox.setToolTip(pyqt.fakeTranslate("Form", "插值曲线引导旋转", None, -1))
        self.interpolated_rotate_checkBox.setText(pyqt.fakeTranslate("Form", "旋转", None, -1))
        self.groupBox_5.setTitle(pyqt.fakeTranslate("Form", "可见性", None, -1))
        self.vis_hair_pushButton.setToolTip(pyqt.fakeTranslate("Form", "切换毛发可见性", None, -1))
        self.vis_hair_pushButton.setText(pyqt.fakeTranslate("Form", "切换毛发", None, -1))
        self.vis_guides_pushButton.setToolTip(pyqt.fakeTranslate("Form", "切换引导线可见性", None, -1))
        self.vis_guides_pushButton.setText(pyqt.fakeTranslate("Form", "切换引导线", None, -1))
        self.vis_scalp_pushButton.setToolTip(pyqt.fakeTranslate("Form", "切换头皮可见性", None, -1))
        self.vis_scalp_pushButton.setText(pyqt.fakeTranslate("Form", "切换头皮", None, -1))
