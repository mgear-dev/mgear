...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.foc_checkBox.setToolTip(QtWidgets.QApplication.translate("Form", "<html><head/><body><p>在链的前面(FOC)创建一个新的混合变形节点</p></body></html>", None, -1))
        self.foc_checkBox.setText(QtWidgets.QApplication.translate("Form", "在链前面创建新的混合变形节点", None, -1))
        self.useExistingBS_checkBox.setToolTip(QtWidgets.QApplication.translate("Form", "<html><head/><body><p>Crank将只使用<span style=\" font-weight:600;\">未被其他Crank层管理</span>的现有混合变形节点。<br/>如果找到任何合适的混合变形节点，工具将<span style=\" font-weight:600;\">不会</span>为给定对象创建新节点，层创建将中止</p></body></html>", None, -1))
        self.useExistingBS_checkBox.setText(QtWidgets.QApplication.translate("Form", "仅使用现有混合变形节点", None, -1))
        self.groupBox_2.setTitle(QtWidgets.QApplication.translate("Form", "雕刻帧", None, -1))
        self.label_4.setText(QtWidgets.QApplication.translate("Form", "后保持", None, -1))
        ...
        self.label_3.setText(QtWidgets.QApplication.translate("Form", "前保持", None, -1))
        ...
        self.editOFF_pushButton.setText(QtWidgets.QApplication.translate("Form", "关闭所有层编辑", None, -1))
