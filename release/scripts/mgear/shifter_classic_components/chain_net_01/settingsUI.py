...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.groupBox_3.setTitle("Chain Master")
        ...
        self.masterB_pushButton.setText("<<")
        ...
        self.masterA_pushButton.setText("<<")
        ...
        self.jntNb_label_2.setText("Connection Offset")
        ...
        self.cnxOffset_spinBox.setToolTip("<html><head/><body><p>Index value to offset the connection between the Master chains and the slave chain. For example if the slave chain need to start the rotation from the second segment of the master chain, the offset will be 1.</p><p><span style=\" font-weight:600;\">WARNING</span>: If connection is out of index, will fallback to connect to the latest section in the master</p></body></html>")
        ...
        self.jntNb_label_3.setText("Bias A/B")
        ...
        self.groupBox_4.setTitle("Visibility UI host")
        ...
        self.label_2.setText("Vis. Host")
        self.horizontalLayout_3.addWidget(self.label_2)
        self.visHost_lineEdit = QtWidgets.QLineEdit(self.groupBox_4)
        self.visHost_lineEdit.setObjectName("visHost_lineEdit")
        self.visHost_lineEdit.setToolTip("<html><head/><body><p>In some situations the visibility channel controls  for FK and IK controls needs to be separated of the other component control channels.</p><p>If a host is set here will use this host as UI host for visibility channels. If nothing is set will use the regular UI host configuration.</p></body></html>")
        ...
        self.visHost_pushButton.setToolTip("<html><head/><body><p>In some situations the visibility channel controls  for FK and IK controls needs to be separated of the other component control channels.</p><p>If a host is set here will use this host as UI host for visibility channels. If nothing is set will use the regular UI host configuration.</p></body></html>")
        self.visHost_pushButton.setText("<<")
