...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.ikfk_label.setText(gqt.fakeTranslate("Form", "IK/FK混合", None, -1))
        ...
        self.ikTR_checkBox.setText(gqt.fakeTranslate("Form", "IK分离移动和旋转控制器", None, -1))
        ...
        self.mirrorMid_checkBox.setText(gqt.fakeTranslate("Form", "Mirror中间 Ctl and UPV  axis behaviour", None, -1))
        ...
        self.extraTweak_checkBox.setText(gqt.fakeTranslate("Form", "添加 Extra Tweak Ctl", None, -1))
        ...
        self.supportJoints_checkBox.setText(gqt.fakeTranslate("Form", "Support Elbow 骨骼s", None, -1))
        ...
        self.ikRefArray_copyRef_pushButton.setText(gqt.fakeTranslate("Form", "从上矢量参考复制", None, -1))
        ...
        self.upvRefArray_groupBox.setTitle(gqt.fakeTranslate("Form", "上矢量参考阵列", None, -1))
        self.upvRefArray_copyRef_pushButton.setText(gqt.fakeTranslate("Form", "从IK参考复制", None, -1))
        ...
        self.pinRefArray_groupBox.setTitle(gqt.fakeTranslate("Form", "固定肘部参考阵列", None, -1))
        self.pinRefArray_copyRef_pushButton.setText(gqt.fakeTranslate("Form", "从IK参考复制", None, -1))
