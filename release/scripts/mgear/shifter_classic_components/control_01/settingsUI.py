...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.addLeafJoint_checkBox.setText(gqt.fakeTranslate("Form", "添加 Leaf Joint", None, -1))
        ...
        self.leafJoint_checkBox.setText(gqt.fakeTranslate("Form", "is Leaf 骨骼", None, -1))
