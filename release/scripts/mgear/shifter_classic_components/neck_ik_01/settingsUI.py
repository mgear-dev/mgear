...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.tangentControls_label.setText(gqt.fakeTranslate("Form", "Tangent 控制器s", None, -1))
        ...
        self.headRefArray_copyRef_pushButton.setText(gqt.fakeTranslate("Form", "从IK参考复制", None, -1))
