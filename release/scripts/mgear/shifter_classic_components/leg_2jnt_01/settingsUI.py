...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.mirrorMid_checkBox.setText(gqt.fakeTranslate("Form", "Mirror 中间 Ctl and UPV  axis", None, -1))
        ...
        self.supportJoints_checkBox.setText(gqt.fakeTranslate("Form", "Support Knee 骨骼s", None, -1))
