...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.ikfk_label.setText("FK/IK Blend")
        ...
        self.maxStretch_label.setText("Max Stretch")
        ...
        self.maxStretch_label_2.setText("Elbow Thickness")
        ...
        self.ikTR_checkBox.setText("IK separated Trans and Rot ctl")
        ...
        self.mirrorIK_checkBox.setToolTip("This option set the axis of the mid CTL (elbow) and the up vector control to move in a mirror behaviour ")
        self.mirrorIK_checkBox.setStatusTip("This option set the axis of the mid CTL (elbow) and the up vector control to move in a mirror behaviour ")
        self.mirrorIK_checkBox.setWhatsThis("This option set the axis of the mid CTL (elbow) and the up vector control to move in a mirror behaviour ")
        self.mirrorIK_checkBox.setText("Mirror IK Ctl  axis behaviour")
        ...
        self.mirrorMid_checkBox.setToolTip("This option set the axis of the mid CTL (elbow) and the up vector control to move in a mirror behaviour ")
        self.mirrorMid_checkBox.setStatusTip("This option set the axis of the mid CTL (elbow) and the up vector control to move in a mirror behaviour ")
        self.mirrorMid_checkBox.setWhatsThis("This option set the axis of the mid CTL (elbow) and the up vector control to move in a mirror behaviour ")
        self.mirrorMid_checkBox.setText("MirrorMid Ctl and UPV  axis behaviour")
        ...
        self.extraTweak_checkBox.setToolTip("This option set the axis of the mid CTL (elbow) and the up vector control to move in a mirror behaviour ")
        self.extraTweak_checkBox.setStatusTip("This option set the axis of the mid CTL (elbow) and the up vector control to move in a mirror behaviour ")
        self.extraTweak_checkBox.setWhatsThis("This option set the axis of the mid CTL (elbow) and the up vector control to move in a mirror behaviour ")
        self.extraTweak_checkBox.setText("Add Extra Tweak Ctl")
        ...
        self.supportJoints_checkBox.setToolTip("This option set the axis of the mid CTL (elbow) and the up vector control to move in a mirror behaviour ")
        self.supportJoints_checkBox.setStatusTip("This option set the axis of the mid CTL (elbow) and the up vector control to move in a mirror behaviour ")
        self.supportJoints_checkBox.setWhatsThis("This option set the axis of the mid CTL (elbow) and the up vector control to move in a mirror behaviour ")
        self.supportJoints_checkBox.setText("Support Elbow Joints")
        ...
        self.guideOrientWrist_checkBox.setToolTip("This option aligns the wrist with the guide. NOTE: This option override Mirror IK ctl behaviour")
        self.guideOrientWrist_checkBox.setStatusTip("This option aligns the wrist with the guide.")
        self.guideOrientWrist_checkBox.setWhatsThis("This option aligns the wrist with the guide.")
        self.guideOrientWrist_checkBox.setText("Align wrist to guide orientation")
        ...
        self.squashStretchProfile_pushButton.setText("Squash and Stretch Profile")
        ...
        self.ikRefArray_copyRef_pushButton.setText("Copy from UpV Ref")
        ...
        self.upvRefArray_groupBox.setTitle("UpV Reference Array")
        ...
        self.upvRefArray_copyRef_pushButton.setText("Copy from IK Ref")
        ...
        self.pinRefArray_groupBox.setTitle("Pin Elbow Reference Array")
        ...
        self.pinRefArray_copyRef_pushButton.setText("Copy from IK Ref")
