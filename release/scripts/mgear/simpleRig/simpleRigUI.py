...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.createRoot_pushButton.setText(pyqt.fakeTranslate("MainWindow", "创建根", None, -1))
        ...
        self.side_comboBox.setItemText(0, pyqt.fakeTranslate("MainWindow", "中心", None, -1))
        self.side_comboBox.setItemText(1, pyqt.fakeTranslate("MainWindow", "左", None, -1))
        self.side_comboBox.setItemText(2, pyqt.fakeTranslate("MainWindow", "右", None, -1))
        self.label_3.setText(pyqt.fakeTranslate("MainWindow", "位置", None, -1))
        self.position_comboBox.setItemText(0, pyqt.fakeTranslate("MainWindow", "几何中心", None, -1))
        self.position_comboBox.setItemText(1, pyqt.fakeTranslate("MainWindow", "几何底部(Y轴最低点)", None, -1))
        ...
        self.selectAffected_pushButton.setText(pyqt.fakeTranslate("MainWindow", "选择受影响对象", None, -1))
        self.groupBox.setTitle(pyqt.fakeTranslate("MainWindow", "轴心点", None, -1))
        self.editPivot_pushButton.setText(pyqt.fakeTranslate("MainWindow", "编辑轴心点", None, -1))
        self.setPivot_pushButton.setText(pyqt.fakeTranslate("MainWindow", "设置轴心点", None, -1))
        self.reParentPivot_pushButton.setText(pyqt.fakeTranslate("MainWindow", "重新父化轴心点", None, -1))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.rig_tab), pyqt.fakeTranslate("MainWindow", "绑定", None, -1))
        self.groupBox_6.setTitle(pyqt.fakeTranslate("MainWindow", "根", None, -1))
        ...
        self.groupBox_8.setTitle(pyqt.fakeTranslate("MainWindow", "主控制器(世界、本地、全局)", None, -1))
        self.fixSize_checkBox.setText(pyqt.fakeTranslate("MainWindow", "使用固定大小", None, -1))
        self.worldCenter_checkBox.setText(pyqt.fakeTranslate("MainWindow", "主控制器在世界中心", None, -1))
        self.label_5.setText(pyqt.fakeTranslate("MainWindow", "本地/全局控制器形状", None, -1))
        ...
        self.groupBox_7.setTitle(pyqt.fakeTranslate("MainWindow", "自定义集合", None, -1))
        self.extraSets_label.setText(pyqt.fakeTranslate("MainWindow", "额外控制器集合", None, -1))
        ...
        self.convertToShifterRig_action.setText(pyqt.fakeTranslate("MainWindow", "转换为Shifter绑定", None, -1))
        self.createShifterGuide_action.setText(pyqt.fakeTranslate("MainWindow", "创建Shifter引导", None, -1))
        self.deleteRig_action.setText(pyqt.fakeTranslate("MainWindow", "删除绑定", None, -1))
        self.deletePivot_action.setText(pyqt.fakeTranslate("MainWindow", "删除轴心点", None, -1))
        self.autoBuild_action.setText(pyqt.fakeTranslate("MainWindow", "自动构建", None, -1))
