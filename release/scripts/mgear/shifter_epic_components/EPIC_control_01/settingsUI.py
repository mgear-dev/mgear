...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.descriptionName_checkBox.setToolTip("<html><head/><body><p>If checked will use the component name as description name for joints. This is ideal for the default EPIC naming system.<br/>If we are using default mGear\'s naming system, is recommended to uncheck this option to avoid repetition in the names.</p></body></html>")
        ...
        self.groupBox_4.setTitle("UE Control Rig Settings")
        ...
        self.label_2.setToolTip("<html><head/><body><p>Specifies the fallback reference joint to use for Unreal Control Rig backward solve when the control has no associated joint.</p></body></html>")
        self.label_2.setText("Backward Solve Reference Joint")
        ...
        self.backwards_ref_jnt_lineEdit.setToolTip("<html><head/><body><p>Specifies the fallback reference joint to use for Unreal Control Rig backward solve when the control has no associated joint.</p></body></html>")
        ...
        self.backwards_ref_jnt_pushButton.setToolTip("<html><head/><body><p>Specifies the fallback reference joint to use for Unreal Control Rig backward solve when the control has no associated joint.</p></body></html>")
        self.backwards_ref_jnt_pushButton.setText("<<")
