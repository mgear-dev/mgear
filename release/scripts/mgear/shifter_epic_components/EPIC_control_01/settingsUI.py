...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.joint_checkBox.setText(gqt.fakeTranslate("Form", "骨骼", None, -1))
        self.uniScale_checkBox.setText(gqt.fakeTranslate("Form", "Uniform 缩放", None, -1))
        ...
        self.neutralRotation_checkBox.setText(gqt.fakeTranslate("Form", "世界 Space Orientation Align", None, -1))
        self.mirrorBehaviour_checkBox.setToolTip(gqt.fakeTranslate("Form", "<html><head/><body><p>If is active, the control will have symmetrical behaviour on Left and 绑定ht side.</p><p><br/></p><p>WARNING: There is a bug in Maya 2018 and 2018.1 that will result in an incorrect behaviour, because this option will negate one of the axis. Other Maya version should be ok.</p></body></html>", None, -1))
        ...
        self.ctlSize_label.setText(gqt.fakeTranslate("Form", "Ctl 大小", None, -1))
        ...
        self.translate_pushButton.setText(gqt.fakeTranslate("Form", "移动", None, -1))
        ...
        self.groupBox_4.setTitle(gqt.fakeTranslate("Form", "UE Control Rig 设置", None, -1))
        self.label_2.setToolTip(gqt.fakeTranslate("Form", "<html><head/><body><p>Specifies the fallback reference joint to use for Unreal 控制器 Rig backward solve when the control has no associated joint.</p></body></html>", None, -1))
        self.label_2.setText(gqt.fakeTranslate("Form", "Backward Solve Reference 骨骼", None, -1))
        self.backwards_ref_jnt_lineEdit.setToolTip(gqt.fakeTranslate("Form", "<html><head/><body><p>Specifies the fallback reference joint to use for Unreal 控制器 Rig backward solve when the control has no associated joint.</p></body></html>", None, -1))
        self.backwards_ref_jnt_pushButton.setToolTip(gqt.fakeTranslate("Form", "<html><head/><body><p>Specifies the fallback reference joint to use for Unreal 控制器 Rig backward solve when the control has no associated joint.</p></body></html>", None, -1))
