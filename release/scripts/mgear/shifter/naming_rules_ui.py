...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.ctl_name_rule_lineEdit.setToolTip(gqt.fakeTranslate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">自定义命名规则:</span></p><p>要配置自定义名称，请使用以下标记（用\"<span style=\" font-weight:600;\">{}</span>\"）</p><p><br/></p><p><span style=\" font-weight:600;\">{component}</span> = 组件名称</p><p><span style=\" font-weight:600;\">{side}</span> = 组件侧边</p><p><span style=\" font-weight:600;\">{index</span>} = 组件索引。当多个组件具有相同名称时，此索引很重要</p><p><span style=\" font-weight:600;\">{description}</span> = 组件内对象的名称</p><p><span style=\" font-weight:600;\">{extension}</span> = 对象的扩展名。例如控制器用\"ctl\"，骨骼用\"jnt\"</p><p><br/></p><p><span style=\" font-weight:600;\">注意:</span> 唯一有效的分隔符是\"_\"。这是Maya的限制。</p><p><br/></p><p><br/></p><p><span style=\" font-weight:600;\">这是默认配置:</span></p><p>{component}_{side}{index}_{description}_{extension}</p><p><br/></p><p><br/></p><p><span style=\" font-weight:600;\">其他配置示例:</span></p><p>{component}{side}{index}{description}{extension}</p><p>{component}{index}_{description}_{extension}_{side}</p><p>{component}{index}_some_random_text_{description}_{extension}_{side}</p><p><br/></p><p><span style=\" font-weight:600;\">建议使用所有标记以确保不会发生名称冲突</span></p></body></html>", None, -1))
        ...
        self.label.setText(gqt.fakeTranslate("Form", "{description} 大小写", None, -1))
        ...
        self.groupBox_9.setTitle(gqt.fakeTranslate("Form", "骨骼命名规则", None, -1))
        self.joint_name_rule_lineEdit.setToolTip(gqt.fakeTranslate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">自定义命名规则:</span></p><p>要配置自定义名称，请使用以下标记（用\"<span style=\" font-weight:600;\">{}</span>\"）</p><p><br/></p><p><span style=\" font-weight:600;\">{component}</span> = 组件名称</p><p><span style=\" font-weight:600;\">{side}</span> = 组件侧边</p><p><span style=\" font-weight:600;\">{index</span>} = 组件索引。当多个组件具有相同名称时，此索引很重要</p><p><span style=\" font-weight:600;\">{description}</span> = 组件内对象的名称</p><p><span style=\" font-weight:600;\">{extension}</span> = 对象的扩展名。例如控制器用\"ctl\"，骨骼用\"jnt\"</p><p><br/></p><p><span style=\" font-weight:600;\">注意:</span> 唯一有效的分隔符是\"_\"。这是Maya的限制。</p><p><br/></p><p><br/></p><p><span style=\" font-weight:600;\">这是默认配置:</span></p><p>{component}_{side}{index}_{description}_{extension}</p><p><br/></p><p><br/></p><p><span style=\" font-weight:600;\">其他配置示例:</span></p><p>{component}{side}{index}{description}{extension}</p><p>{component}{index}_{description}_{extension}_{side}</p><p>{component}{index}_some_random_text_{description}_{extension}_{side}</p><p><br/></p><p><span style=\" font-weight:600;\">建议使用所有标记以确保不会发生名称冲突</span></p></body></html>", None, -1))
        ...
        self.label_3.setText(gqt.fakeTranslate("Form", "{description} 大小写", None, -1))
        ...
        self.groupBox_10.setTitle(gqt.fakeTranslate("Form", "控制器侧边命名", None, -1))
        self.label_4.setText(gqt.fakeTranslate("Form", "左", None, -1))
        self.side_left_name_lineEdit.setToolTip(gqt.fakeTranslate("Form", "<html><head/><body><p>设置用于侧边的文本:</p><p><br/></p><p><span style=\" font-weight:600;\">例如:</span></p><p>L</p><p>left</p><p>Left</p><p>l</p><p><br/></p><p>r</p><p>right</p><p>Right</p><p>Derecha</p><p>R</p><p><br/></p><p><br/></p></body></html>", None, -1))
        self.side_left_name_lineEdit.setText(gqt.fakeTranslate("Form", "L", None, -1))
        self.label_5.setText(gqt.fakeTranslate("Form", "右", None, -1))
        self.side_right_name_lineEdit.setToolTip(gqt.fakeTranslate("Form", "<html><head/><body><p>设置用于侧边的文本:</p><p><br/></p><p><span style=\" font-weight:600;\">例如:</span></p><p>L</p><p>left</p><p>Left</p><p>l</p><p><br/></p><p>r</p><p>right</p><p>Right</p><p>Derecha</p><p>R</p><p><br/></p><p><br/></p></body></html>", None, -1))
        self.side_right_name_lineEdit.setText(gqt.fakeTranslate("Form", "R", None, -1))
        self.label_6.setText(gqt.fakeTranslate("Form", "中", None, -1))
        self.side_center_name_lineEdit.setToolTip(gqt.fakeTranslate("Form", "<html><head/><body><p>设置用于侧边的文本:</p><p><br/></p><p><span style=\" font-weight:600;\">例如:</span></p><p>L</p><p>left</p><p>Left</p><p>l</p><p><br/></p><p>r</p><p>right</p><p>Right</p><p>Derecha</p><p>R</p><p><br/></p><p><br/></p></body></html>", None, -1))
        ...
        self.groupBox_12.setTitle(gqt.fakeTranslate("Form", "骨骼侧边命名", None, -1))
        self.label_9.setText(gqt.fakeTranslate("Form", "左", None, -1))
        self.side_joint_left_name_lineEdit.setToolTip(gqt.fakeTranslate("Form", "<html><head/><body><p>设置用于侧边的文本:</p><p><br/></p><p><span style=\" font-weight:600;\">例如:</span></p><p>L</p><p>left</p><p>Left</p><p>l</p><p><br/></p><p>r</p><p>right</p><p>Right</p><p>Derecha</p><p>R</p><p><br/></p><p><br/></p></body></html>", None, -1))
        self.side_joint_left_name_lineEdit.setText(gqt.fakeTranslate("Form", "L", None, -1))
        self.label_10.setText(gqt.fakeTranslate("Form", "右", None, -1))
        self.side_joint_right_name_lineEdit.setToolTip(gqt.fakeTranslate("Form", "<html><head/><body><p>设置用于侧边的文本:</p><p><br/></p><p><span style=\" font-weight:600;\">例如:</span></p><p>L</p><p>left</p><p>Left</p><p>l</p><p><br/></p><p>r</p><p>right</p><p>Right</p><p>Derecha</p><p>R</p><p><br/></p><p><br/></p></body></html>", None, -1))
        self.side_joint_right_name_lineEdit.setText(gqt.fakeTranslate("Form", "R", None, -1))
        self.label_11.setText(gqt.fakeTranslate("Form", "中", None, -1))
        self.side_joint_center_name_lineEdit.setToolTip(gqt.fakeTranslate("Form", "<html><head/><body><p>设置用于侧边的文本:</p><p><br/></p><p><span style=\" font-weight:600;\">例如:</span></p><p>L</p><p>left</p><p>Left</p><p>l</p><p><br/></p><p>r</p><p>right</p><p>Right</p><p>Derecha</p><p>R</p><p><br/></p><p><br/></p></body></html>", None, -1))
        ...
        self.label_13.setText(gqt.fakeTranslate("Form", "骨骼", None, -1))
        self.groupBox_11.setTitle(gqt.fakeTranslate("Form", "扩展名命名", None, -1))
        self.label_7.setText(gqt.fakeTranslate("Form", "控制器", None, -1))
        self.ctl_name_ext_lineEdit.setToolTip(gqt.fakeTranslate("Form", "<html><head/><body><p>设置控制器的扩展名</p><p><br/></p><p><span style=\" font-weight:600;\">例如:</span></p><p>ctl</p><p>control</p><p>mover</p><p>ct</p><p>等..</p></body></html>", None, -1))
        self.ctl_name_ext_lineEdit.setText(gqt.fakeTranslate("Form", "ctl", None, -1))
        self.label_8.setText(gqt.fakeTranslate("Form", "骨骼", None, -1))
        self.joint_name_ext_lineEdit.setToolTip(gqt.fakeTranslate("Form", "<html><head/><body><p>设置骨骼的扩展名</p><p><br/></p><p><span style=\" font-weight:600;\">例如:</span></p><p>jnt</p><p>joint</p><p>bone</p><p>j</p><p>等..</p></body></html>", None, -1))
