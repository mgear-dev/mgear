...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox_2.setTitle(gqt.fakeTranslate("Form", "主指南模板", None, -1))
        self.load_pushButton.setText(gqt.fakeTranslate("Form", "...", None, -1))
        self.groupBox.setTitle(gqt.fakeTranslate("Form", "差异测试选项", None, -1))
        self.missingGuide_checkBox.setText(gqt.fakeTranslate("Form", "缺失的指南组件", None, -1))
        self.extraGuide_checkBox.setText(gqt.fakeTranslate("Form", "多余的指南组件", None, -1))
